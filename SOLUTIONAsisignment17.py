# -*- coding: utf-8 -*-
"""
Created on Mon Sep 19 16:58:39 2022
...
# Q.3) Use a for loop to print the values of the list [3, 2, 1, 0].
section = '4.3'
print_header(section)
numbers = [3, 2, 1, 0]
for num in numbers:
...
# Q.5) Use a dictionary comprehension to create the dictionary squares. Use range(10)
...
# Q.6) Use a set comprehension to create the set odd from the odd numbers in
# range(10)
section = '4.6'
print_header(section)
limit = 10
...
# Q.7) Use a generator comprehension to return the string 'Got ' and a number for the
...
# Q.8) Define a function called good that returns the list ['Harry', 'Ron', 'Her
# mione']
section = '4.8'
print_header(section)
...
# Q.9) Define a generator function called get_odds that returns the odd numbers from
